...
abstract class DatabaseTestCase extends TestCase
{
    ...
    private function truncate(): void
    {
        ...
        foreach (['queue_items', 'song_requests', 'announcements', 'singers', 'songs', 'audit_log', 'settings', 'payments_tips', 'display_screens', 'display_state', 'realtime_events', 'events', 'show_schedules', 'karaoke_sessions', 'venues', 'password_reset_tokens', 'users'] as $table) {
            try {
